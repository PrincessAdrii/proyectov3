...
<div class="card p-4 shadow-sm">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input  style=" background-color: #d4d2d2;" type="number" class="form-control" id="semestreActual" name="semestreActual" value="{{ old('semestreActual', $alumno->semestreActual ?? 'semestre 1') }}" readonly >
        </div>
        @endif
        <!-- Campo: Carrera -->
        <div class="col-md-6 mb-3">
